...
Two faults were diagnosed that evening. Neither was visible in any log. Both were found by **comparing a suspect node against a known-good identical one**. One of them was misdiagnosed twice first.
